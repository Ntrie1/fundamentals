function piccolo(input) {
    ...
    let sortedCarsNumber = Array.from(parkingList).sort((a, b) => a[0].localeCompare(b[0]))

    if (sortedCarsNumber.length === 0) {
        console.log("Parking Lot is Empty.");
    }
    sortedCarsNumber.forEach((carNumber) => console.log((carNumber[0])));
