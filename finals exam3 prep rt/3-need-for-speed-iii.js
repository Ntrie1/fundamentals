function needForSpeed(input) {
    ...
    while (commandLine !== 'Stop') {
        let [command, carName, firstaArgument, secondArgument] = commandLine.split(' : ');


        switch (command) {
            case 'Drive': {
                let distance = Number(firstaArgument)
            ...
            case 'Refuel': {
                let fuel = Number(firstaArgument);
            ...
            case 'Revert': {
                let kilometers = Number(firstaArgument);
